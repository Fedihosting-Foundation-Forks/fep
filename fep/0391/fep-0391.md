...
```json
{
	...
	"result": {
		...
		"inReplyTo": "https://example.com/some-create"
	}
}
```
...
```json
{
	...
	"result": {
		...
		"inReplyTo": "https://example.com/create-some-reply"
	}
}
```
...
```json
{
	...
	"result": {
		...
		"inReplyTo": "https://example.com/some-activity"
	}
}
```
...
{
	"@context": ["https://www.w3.org/ns/activitystreams", "https://w3id.org/fep/0391"],
	"id": "https://example.com/create-some-comment",
	"actor": "https://example.com/some-actor",
	"type": "Create",
	"object": {
		"id": "https://example.com/some-object",
	...
	"result": {
		...
		"target": "https://example.com/some-context",
		"inReplyTo": "https://example.com/create-some-comment"
	}
}
```
...
```json
{
	...
	"result": {
		...
		"inReplyTo": "https://example.com/some-like"
	}
}
```
...
```json
{
	...
	"result": {
		...
		"inReplyTo": "https://example.com/some-announce"
	}
}
```
		...
		"result": [
			{
				...
				"object": "https://example.com/actors/2",
				"target": "https://example.com/actors/1/followers",
				"inReplyTo": "https://example.com/accept-follow"
			},
			{
