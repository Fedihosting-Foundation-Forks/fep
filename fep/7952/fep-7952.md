...
There are several methods of achieving these types of IDs, including:
...
* [FEP-e3e9: Actor-Relative URLs](https://codeberg.org/fediverse/fep/src/commit/29dbcd0196eefe05c59656608d17c5991563e42e/fep/e3e9/fep-e3e9.md) 
  (regular `https://` URLs that are redirected to their current location via a 302 http
  redirect).
...
different inbox/outbox and storage providers, without breaking actor-relative links. 
...
must be functionally independent of all other services.
